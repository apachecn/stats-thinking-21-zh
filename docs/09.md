...
我们将要讨论的假设检验，具体来说是*零假设统计检验* (NHST)。如果随手翻基本关于科学或生物医学研究出版物，你都会看到 NHST 被用来测试假设，在心理学入门教科书中，格里克&津巴多(2002)将 NHST 称为“心理学研究的支柱”。因此，学习如何使用和解释假设检验的结果对于理解许多研究领域的结果是至关重要的。
